...
void main()
{
    ...
    configure_gpio(19, GPIO_MODE_USER_STD_INPUT_PULLDOWN);
    ...
    configure_gpio(27, GPIO_MODE_USER_STD_INPUT_PULLDOWN);
    ...
    configure_gpio(32, GPIO_MODE_USER_STD_INPUT_PULLDOWN);
    ...
    configure_gpio(15, GPIO_MODE_USER_STD_OUTPUT);
    configure_gpio(16, GPIO_MODE_USER_STD_OUTPUT);
