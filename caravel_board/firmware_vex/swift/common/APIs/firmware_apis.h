 ...
 */
void enableHkSpi(int is_enable) { reg_hkspi_disable = !is_enable; }
// debug regs
#ifndef DOXYGEN_SHOULD_SKIP_THIS
...
void wait_debug_reg1(unsigned int data)
{
    while (get_debug_reg1() != data)
        ;
}
void wait_debug_reg2(unsigned int data)
{
...
void wait_gpio_user_l(unsigned int data)
{
