 ...
 */
void USER_writeHalfWord(unsigned short data,unsigned int offset,int is_first_word){
 ...
 */
unsigned short USER_readHalfWord(unsigned int offset,int is_first_word){
    unsigned int half_word_offset = offset *2 + is_first_word;
