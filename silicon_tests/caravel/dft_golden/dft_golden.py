...
instruction=0b0011
in_vector_size = 5112
out_vector_size = 5392
in_vector_bytes_num = 639
out_vector_bytes_num = 674
total_vectors=277
in_vec_file_path = "in_vectors.bin"
golden_vec_file_path = "out_vectors.bin"
...
#           Check the output test vectors against the golden test vectors
            for i in range(out_vector_size):
                if (not (5321<=i<=5352 or 5244<=i<=5275)): # don't care bits
